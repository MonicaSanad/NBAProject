<html>
 ...
 <body>
  ...
  <div class="container">
   <br />
   <h2>Learn more about players!</h2><br />
   <div class="form-group">
    <div class="input-group">
     <span class="input-group-text">Search</span>
     <input type="text" name="search_text" id="search_text" placeholder="Search by player information" class="form-control" />
    </div>
   </div>
   <br />
   <div id="result"></div>
   <form method="post" action="php/fetch.php" class="row">
	<div class="col-6"></div>
